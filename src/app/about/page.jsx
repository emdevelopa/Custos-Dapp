...
const About = () => {
  ...
  return (
    <main className="relative min-h-screen text-white">
      ...
      <div className="container relative mx-auto px-4 py-16">
        ...
        {/* Headline */}
        <h1 className="mt-16 mb-20 text-center text-4xl font-bold leading-tight bg-gradient-to-r from-[#EAF9FF] to-[#8E9A9A] bg-clip-text text-transparent md:text-5xl lg:text-6xl">
  ...
  <div className="relative max-w-[400px] sm:max-w-[550px] rounded-3xl overflow-hidden">
    ...
    />
    <div className="absolute inset-0 p-4 sm:p-6 bg-opacity-50 backdrop-blur-sm flex flex-col justify-center">
      <div className="flex items-center gap-4">
        ...
        />
        <h2 className="text-xl sm:text-2xl font-semibold bg-gradient-to-r from-[#0094FF] via-[#5643F1] to-[#A02294] bg-clip-text text-transparent">
          About Custos Diretriz
        </h2>
      </div>
      <p className="text-xl sm:text-lg text-[#E5E7EB] mt-4 leading-relaxed">
    ...
    <div className="absolute inset-0 p-6 sm:p-8 bg-opacity-50 backdrop-blur-sm flex flex-col justify-center">
      ...
      <p className="text-sm sm:text-lg text-[#E5E7EB] mt-4 leading-relaxed">
        ...
        <section className="flex flex-wrap justify-center gap-6 mb-20">
          {[
            ...
            <div
              ...
              style={{
                borderImage: "linear-gradient(to right, #0094FF, #5643F1, #A02294) 1",
              }}
            >
              <Image
        ...
        <section className="mb-20 text-center">
          ...
          <button className="inline-flex items-center gap-2 text-white text-sm py-4 px-8 rounded-full bg-[#84c2f513] backdrop-blur-[10px] hover:bg-[#209af1] transition-colors duration-300"
          style={{
                borderImage: "linear-gradient(to right, #0094FF, #5643F1, #A02294) 1",
              }}>
            Send Us a Message
